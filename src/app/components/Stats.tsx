  ...
  return (
    <section className="py-20 bg-white border-t border-gray-100">
      <div className="container mx-auto px-4 md:px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-16 text-gray-900">Números que Comprovam</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
           {stats.map((stat, idx) => (
              <div key={idx} className="p-6 rounded-2xl hover:bg-gray-50 transition-colors">
                 ...
                 <p className={`text-4xl lg:text-5xl font-black mb-4 ${stat.color}`}>{stat.number}</p>
        ...
        <p className="mt-12 text-sm text-gray-400">
           92% dos usuários avaliaram como "excelente" o maeorganiza.com<br/>
